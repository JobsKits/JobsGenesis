...
SUBMODULE_REPO_URLS=(
  "https://github.com/JobsKits/JobsCommand-iOS|JobsCommand@iOS"
  "https://github.com/JobsKits/JobsCommand-Flutter|JobsCommand@Flutter"
...
run_main_business_flow() {
  ...
  # 执行当前流程中的独立业务步骤：cd_to_script_dir。
  cd_to_script_dir
  ...
  # 检查当前步骤所需的环境、路径或输入条件。
  ensure_parent_branch
  # 执行当前流程中的独立业务步骤：parent_pull_rebase。
  parent_pull_rebase
